...
// Fallback als de JSON leeg is of niet bestaat
if (!$store) {
...
// --- 2. DE ENGINE: DATA GENEREREN OP BASIS VAN EAN ---
function getProductDetails($ean) {
    // Dynamische Bol.com zoeklink
    $bolSearchUrl = "https://www.bol.com/nl/nl/s/?searchtext=" . $ean;
    
    // Voorspelde CDN URL (Soms werkt dit direct, soms niet - daarvoor is de fallback in HTML)
...
<nav class="navbar sticky-top">
    <div class="container">
        ...
        <div class="ms-auto d-flex align-items-center">
            <span class="badge bg-light text-dark border me-2">EAN Engine Active</span>
            <?php if($isAdmin): ?> <span class="badge bg-danger rounded-pill px-3 shadow-sm">ADMIN</span> <?php endif; ?>
        </div>
    </div>
</nav>
...
<header class="hero-gradient text-center">
    <div class="container text-white">
        ...
        <p class="lead opacity-75 fs-4 text-white">Geautomatiseerd assortiment beheer via EAN-Sync technologie.</p>
    </div>
</header>
    ...
    <div class="row g-4">
        <?php if(empty($store['products'])): ?>
            <div class="col-12 text-center py-5">
                <h3>Geen producten gevonden in products.json</h3>
            </div>
        <?php else: ?>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card product-card p-4">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <span class="api-badge text-success">● LIVE SYNC</span>
                    </div>
                    ...
                    <div class="p-3 bg-light rounded-4 border mb-4 mt-auto">
                        ...
                        <div class="text-center mt-2">
                            <small class="text-muted" style="font-size: 0.6rem;">SYNC ID: <?php echo $details['sync_id']; ?> | <?php echo $details['timestamp']; ?></small>
                        </div>
                    </div>
...
<footer class="py-5 bg-dark text-white text-center">
    <div class="container text-white">
        ...
        <p class="text-muted small">Middleware: Serverless PHP | Data: Headless JSON</p>
    </div>
</footer>
